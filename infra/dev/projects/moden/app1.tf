...
module "ecr_app1" {
  ...
  repository_name      = module.common_app1.common_name
  ...
  tags = module.common_app1.common_tags
}

# Route53 DNS Record
module "route53_record_app1" {
...
# Target Group
module "target_group_app1" {
  source = "../../../modules/load-balancer/target-group"

  name = module.common_app1.common_name

  port        = var.app1_target_port
  protocol    = "HTTP"
...
module "listener_rule_app1" {
  source = "../../../modules/load-balancer/rule"

  name         = module.common_app1.common_name
  listener_arn = data.terraform_remote_state.elb.outputs.https_listener_arn
  priority     = var.app1_listener_rule_priority

  host_header_values = var.app1_host_header
  routing_action     = "forward"
  target_group_arn   = module.target_group_app1.target_group_arn
}
