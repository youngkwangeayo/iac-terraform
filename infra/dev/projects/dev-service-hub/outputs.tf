...
output "node_group_ids" {
  description = "서비스별 EKS node group ID"
  value       = { for k, ng in aws_eks_node_group.services : k => ng.id }
}

output "node_group_statuses" {
  description = "서비스별 EKS node group status"
  value       = { for k, ng in aws_eks_node_group.services : k => ng.status }
}
